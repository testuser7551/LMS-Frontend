...
const AddUser = ({ setShowRegisterModal, onUserAdded, schoolId ,schoolObjectId }) => {
      ...
      <div className="w-full max-w-md mx-auto bg-white rounded-2xl shadow-2xl p-6 sm:p-8 border border-gray-100">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <button
            ...
            className="absolute md:top-20 top-30  right-10 text-2xl text-gray-500 hover:text-gray-700 z-50"
          >
            ✕
          </button>
