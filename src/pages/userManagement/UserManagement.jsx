...
// import { Search, UserPlus } from "lucide-react"; // using lucide icons
...
//                                 }}
//                                 className={`px-4 py-2 rounded-lg text-sm font-medium transition font-outfit ${activeTab === tab
...
//                                 />
//                                 <h2 className="font-bold text-lg font-poppins text-primary">{u.name}</h2>
//                                 <span className="text-xs px-3 py-1 bg-activecolor text-primary rounded-full mt-1 font-poppins capitalize">
//                                     {u.role}
//                                 </span>
//                                 <p className="text-xs mt-1 font-poppins text-headcolor">{u.email}</p>
//                                 {/* <span
//                                 className={`mt-2 px-3 py-1 text-xs rounded-full font-poppins ${u.active ? "bg-green-100 text-green-600" : "bg-red-100 text-red-600"
//                                     }`}
//                             >
