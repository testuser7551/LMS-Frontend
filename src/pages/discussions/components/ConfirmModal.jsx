...
const ConfirmModal = ({
  isOpen = true, // optional: default open if used with conditional render
  title = "Confirm",
  message = "Are you sure?",
  onConfirm,
  onCancel,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
        ...
        <div className="flex justify-end gap-3">
          <button
            onClick={onCancel}
            className={`px-4 py-2 rounded-lg ${cancelTextColor} hover:opacity-90 transition ${cancelColor}`}
          >
            {cancelText}
          </button>
          ...
          <button
            onClick={onConfirm}
            className={`px-4 py-2 rounded-lg ${confirmTextColor} hover:opacity-90 transition ${confirmColor}`}
          >
            {confirmText}
          </button>
        </div>
